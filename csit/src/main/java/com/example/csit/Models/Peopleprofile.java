...
public class Peopleprofile {
  ...
  public void setHomeShortaddress(String homeShortaddress) {
    this.homeShortaddress = homeShortaddress;
  }
  ...
  public void setCompanyLongtitude(Double companyLongtitude) {
